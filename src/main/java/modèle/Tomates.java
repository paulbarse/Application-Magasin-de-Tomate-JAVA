...
public class Tomates {
    ...
    private static List<Tomate> tomatesDeTypeAvecListe(TypeTomate typeTomate, List<Tomate> tomates) {
        List<Tomate> listeTomatesDeType = new ArrayList<>();
        for (Tomate tomate : tomates) {
            if (tomate.getType() == typeTomate) {
                listeTomatesDeType.add(tomate);
            }
        }
        return listeTomatesDeType;
    }
    ...
    public List<Tomate> tomatesDetypeDeCouleur(TypeTomate typeTomate,
            Couleur couleur) {
    	List<Tomate> listeTomatesDeTypeEtCouleur = new ArrayList<>();
        for (Tomate tomate : tomates) {
            if (tomate.getCouleur() == couleur && tomate.getType() == typeTomate) {
            	listeTomatesDeTypeEtCouleur.add(tomate);
            }
        }
        return listeTomatesDeTypeEtCouleur;
    }
